      ...
      <div className='image-view' tabIndex='-1'>
        <div className='image-view-Controls' ref='imageControls'>
          <div className='image-view-Controls-group'>
            <span className='image-view-ColorPicker image-view-ColorPicker--transparent' ref='transparentTransparentBackgroundButton' value='transparent'></span>
            <span className='image-view-ColorPicker image-view-ColorPicker--white' ref='whiteTransparentBackgroundButton' value='white'></span>
            <span className='image-view-ColorPicker image-view-ColorPicker--black' ref='blackTransparentBackgroundButton' value='black'></span>
          </div>
