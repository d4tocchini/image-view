...
export default class ImageEditorView {
  ...
  render () {
    return (
      <div className='image-view' tabIndex='-1'>
        <div className='image-view-Controls' ref='imageControls'>
          <div className='image-view-Controls-group'>
            <a className='image-view-ColorPicker image-view-ColorPicker--white' ref='whiteTransparentBackgroundButton' value='white'>white</a>
            <a className='image-view-ColorPicker image-view-ColorPicker--black' ref='blackTransparentBackgroundButton' value='black'>black</a>
            <a className='image-view-ColorPicker image-view-ColorPicker--transparent' ref='transparentTransparentBackgroundButton' value='transparent'>transparent</a>
          </div>
          <div className='image-view-Controls-group btn-group'>
        ...
        <div className='image-view-Container is-zoomToFit' ref='imageContainer'>
          <img className='image-view-Image' ref='image'></img>
        </div>
      </div>
    )
  }
  ...
  resetZoom () {
    ...
    this.refs.imageContainer.classList.remove('is-zoomToFit')
  ...
  zoomToFit () {
    ...
    this.mode = 'zoom-to-fit'
    this.refs.imageContainer.classList.add('is-zoomToFit')
